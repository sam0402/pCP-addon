...
pcp_write_var_to_config USER_COMMAND_2 "sleep+180%3bif+%5b+%60ps+%7c+grep+-c+%27sshd%3a+tc%27%60+-lt+3+%5d%3bthen+(pkill+-f+ssh%3bumount+%2ftmp%2ftcloop%2fopenssh)%3bfi"
