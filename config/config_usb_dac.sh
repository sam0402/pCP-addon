...
pcp_write_var_to_config USER_COMMAND_1 "uhubctl+-l2+-a0%3Buhubctl+-l2+-p2+-a1%3Bsleep+180%3Bpkill+-f+httpd%3bif+%5b+%60pgrep+ssh+%7c+wc+-l%60+-lt+3+%5d%3bthen+pkill+-f+ssh%3bfi"
